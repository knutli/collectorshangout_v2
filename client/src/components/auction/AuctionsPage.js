...
import { Input, Divider, Autocomplete, AutocompleteItem } from '@nextui-org/react';
import { collection, getDocs } from "firebase/firestore";
import { db } from './../../firebase-config';
import '../../styles/auctionsPage.css';
import TempHeader from '../content/TempHeader';
import { SIZES, CONDITIONS, COUNTRIES, LEAGUES } from '../AuctionCreateConstants';
  ...
  useEffect(() => {
    const fetchAuctions = async () => {
      try {
        ...
        const sortedAuctions = fetchedAuctions.sort((a, b) => b.endTime - a.endTime);
